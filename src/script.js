...
parameters.insideColor = '#ff6300'
parameters.outideColor = '#1b3984'
 ...
 */
    ...
    const colorOutside = new THREE.Color(parameters.outideColor)
...
gui.addColor(parameters, 'outideColor').onFinishChange(generateGalaxy)
/**
 * Sizes
 */
const sizes = {
